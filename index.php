...
<body>
    <header>
            ...
            <div class="container">
                <div class="header-menu">
                    <ul>
                        <li>
                            <a href="">
                                <img src="image/logo.svg" alt="Apple logo">
                            </a>
                        </li>
                                    ...
                                    <div class="submenu-flex">
                                        <div class="submenuflex-1">
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="">AirPods 2nd generation</a>
                                                </li>
                                                <li>
                                                    <a href="">AirPods 3nd generation</a>
                                                </li>
                                                <li>
                                ...
                                <div class="container">
                                    <div class="submenu-flex">
                                        <div class="submenuflex-1">
                                            <ul>
                                                <li>
                                                    <span>Explore Entertaiment</span>
                                                </li>
                                                <li>
                                                    <a href="">Explore Entertaiment</a>
                                                </li>
                                                <li>
                                                    <a href="">Apple One</a>
                                                </li>
                                    ...
                                    <div class="submenu-flex">
                                        <div class="submenuflex-1">
                                            <ul>
                                                ...
                                                <li>
                                                    <a href="">Authorized Resellers</a>
                                                </li>
                                                <li>
                                                    <a href="">Service & Support</a>
                                                </li>
                                                <li class="minitxt">
                                                    <a href="">Explore All Ways to Buy</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
        ...
        <div class="pro-colors">
            <div class="container">
                <div class="color-flex">
                    ...
                    <div class="only-colors">
                        <div class="purple">
                            <h3 id="purpletitle-1" class="editclass">Deep Purple</h3>
                            <h3 id="purpletitle-2" class="editclass">Silver</h3>
                            <h3 id="purpletitle-3" class="editclass">Gold</h3>
                            <h3 id="purpletitle-4" class="editclass">Space Black</h3>
                        </div>
                        <div class="color-btn">
                            <div btnid="1" class="purple-circle btnjs"></div>
                            <div btnid="2" class="gold-circle btnjs"></div>
                            <div btnid="3" class="silver-circle btnjs"></div>
                            <div btnid="4" class="black-circle btnjs"></div>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="header-video">
            <div class="container">
                <div id="video-center" class="video-center">
                    <video autoplay muted loop>
                        <source src="video/large.mp4" type="video/mp4">
                    </video>
                </div>
                <div class="iphoneimgs">
                    <img id="purpleimg-1" class="editclass" src="image/deep_purple.jpg" alt="">
                    <img id="purpleimg-2" class="editclass" src="image/gold.jpg" alt="">
                    <img id="purpleimg-3" class="editclass" src="image/silver.jpg" alt="">
                    <img id="purpleimg-4" class="editclass" src="image/spaceblack.jpg" alt="">
                </div>
            </div>
        </div>
    </header>
